...
export default function Home() {
    return (
        <main className="px-4 py-6 lg:h-screen">
            <div className="grid h-full grid-cols-[70%_1fr] gap-4 lg:grid-cols-[76%_1fr]">
                <div className="grid h-full grid-cols-2 items-start gap-x-4 gap-y-[4vh] md:grid-cols-3">
                    {images.map((image, i) => (
